...
import { sortingSpeed } from '../../winners/sorting-amount-speed';
import { sortingWinners } from '../../winners/sorting-amount-winners';
import { showGaragePage } from '../../winners/winners-page';
...
body.addEventListener('click', (event) => {
    ...
    if (element.classList.contains('names-columns__wins') || element.classList.contains('names-columns__wins__active')) {
        sortingWinners(event);
    }
    if (element.classList.contains('names-columns__best-time') || element.classList.contains('names-columns__best-time__active')) {
        sortingSpeed(event);
    }
});
